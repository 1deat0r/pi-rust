...
pub use integration::{
    ...
    load_for_mode_with_reason_and_flags_and_previous, load_for_project_trust,
    register_loaded_native_providers, register_native_provider, ExtensionHostState,
    LoadedExtensions,
};
pub use loader::{
    create_extension_runtime, discover_and_load_extensions, discover_and_load_extensions_for_trust,
    discover_extensions_in_dir, load_bundled_extension, load_extension,
    load_extension_from_factory, load_extensions, load_extensions_with_host_actions,
