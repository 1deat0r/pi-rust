...
**Conversion progress: 77.71% — 129 of 166 ledger tasks complete; 37 open.**
...
matrix, client, harness, and reconnect checks are green, while expanded server,
remaining TUI, strict-clippy, PTY rerun, parity, extension-runtime, and
final-audit leaves remain explicitly gated. See [PLAN.md](PLAN.md)
